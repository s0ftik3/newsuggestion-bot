...
module.exports = class Authentication {
    ...
    async login() {
        try {
            ...
            await page
                .waitForNavigation({ timeout: 30000, waitUntil: 'networkidle2' }, console.log('Waiting for authentication. Timeout: 30 seconds.'))
                .then(() => {
            ...
            const username = await page.$eval(
                '#header-panel > div.header-auth > div > span > span.dropdown-menu > ul > li:nth-child(1) > span',
                (el) => el.textContent
            );
